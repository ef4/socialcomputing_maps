...
urlpatterns = patterns('',
    ...
    url(r'^bestmode/chicago$', 'maps.views.chicago_bestmode', name='home'),
    url(r'^trans-efficiency/cambridge$', 'maps.views.cambridge_transefficiency', name='home'),
    url(r'^trans-efficiency/sanfrancisco$', 'maps.views.sanfrancisco_transefficiency', name='home'),
    url(r'^trans-efficiency/manhattan$', 'maps.views.manhattan_transefficiency', name='home'),
    url(r'^trans-efficiency/washingtondc$', 'maps.views.washingtondc_transefficiency', name='home'),
    url(r'^trans-efficiency/brooklyn$', 'maps.views.brooklyn_transefficiency', name='home'),
    url(r'^trans-efficiency/santamonica$', 'maps.views.santamonica_transefficiency', name='home'),
    url(r'^trans-efficiency/boulder$', 'maps.views.boulder_transefficiency', name='home'),
    url(r'^trans-efficiency/philadelphia$', 'maps.views.philadelphia_transefficiency', name='home'),
    url(r'^trans-efficiency/chicago$', 'maps.views.chicago_transefficiency', name='home'),
